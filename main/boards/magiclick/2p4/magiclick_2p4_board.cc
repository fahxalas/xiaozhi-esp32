...
private:
    ...
    void InitializeNv3023Display() {
        ...
        // Usa SpiLcdDisplay directamente para evitar accesos a memoria nula en LVGL
        display_ = new SpiLcdDisplay(panel_io_, panel_, DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_OFFSET_X, DISPLAY_OFFSET_Y, 
            DISPLAY_MIRROR_X, DISPLAY_MIRROR_Y, DISPLAY_SWAP_XY);
    }

public:
    MagiClick2P4Board() : boot_button_(BOOT_BUTTON_GPIO) {
        InitializeI2c();
    ...
    virtual AudioCodec* GetAudioCodec() override {
        static Es8311AudioCodec audio_codec(I2C_NUM_0, AUDIO_CODEC_I2C_ADDR, AUDIO_INPUT_SAMPLE_RATE, AUDIO_OUTPUT_SAMPLE_RATE,
            AUDIO_I2S_SPK_GPIO_BCLK, AUDIO_I2S_SPK_GPIO_LRCK, AUDIO_I2S_SPK_GPIO_DOUT, AUDIO_I2S_MIC_GPIO_SCK, AUDIO_I2S_MIC_GPIO_WS, AUDIO_I2S_MIC_GPIO_DIN,
            AUDIO_CODEC_PA_PIN, AUDIO_CODEC_ES8311_MCLK_PIN);
        return &audio_codec;
    }
